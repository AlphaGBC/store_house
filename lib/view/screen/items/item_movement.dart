...
class ItemMovementView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: controller.isFilteredByDate
            ? Text(
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: controller.isFilteredByDate
                      ...
                      child: controller.statusRequest == StatusRequest.loading
                          ...
                          : controller.isFilteredByDate
                              ? (controller.movements.isEmpty
                                  ? const Center(
                                      child: Text("لا توجد حركات في هذا التاريخ"),
                                    )
  ...
  Widget _buildMovementsList(ItemMovementController controller) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final itemName = move['items_name'] ??
