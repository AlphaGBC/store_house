...
class IncomingInvoicesEdit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<IncomingInvoicesEditController>(
            ...
            child: ListView(
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(labelText: "كمية المستودع", border: OutlineInputBorder()),
                ),
                const SizedBox(height: 15),
                TextField(
                  controller: controller.pos1Count,
                  keyboardType: TextInputType.number,
                  decoration: const InputDecoration(labelText: "كمية نقطة 1", border: OutlineInputBorder()),
                ),
                const SizedBox(height: 15),
                TextField(
                  controller: controller.pos2Count,
                  keyboardType: TextInputType.number,
                  decoration: const InputDecoration(labelText: "كمية نقطة 2", border: OutlineInputBorder()),
                ),
                const SizedBox(height: 15),
                TextField(
