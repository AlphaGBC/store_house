                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildInfoColumn("المستودع (بعد)", item["storehouse_count"].toString()),
                        _buildInfoColumn("نقطة 1 (منقول)", item["pos1_count"].toString()),
                        _buildInfoColumn("نقطة 2 (منقول)", item["pos2_count"].toString()),
                      ],
                    ),
                    if (item["transfer_of_items_note"] != null && item["transfer_of_items_note"].toString().isNotEmpty)
                      Padding(
