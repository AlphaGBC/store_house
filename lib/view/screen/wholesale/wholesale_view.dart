...
class WholesaleView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(centerTitle: true, title: Text("عملاء الجملة")),
      floatingActionButtonLocation: FloatingActionButtonLocation.startFloat,
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Get.toNamed(AppRoute.wholesaleAdd);
        },
        child: Icon(Icons.add, color: AppColor.white),
      ),
      body: SafeArea(
        top: false,
        child: GetBuilder<WholesaleViewController>(
          builder:
              (controller) => Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                item.wholesaleCustomersName ?? "بدون اسم",
                              ...
                              InkWell(
                                ...
                                onTap: () {
                                  showErrorDialog(
                                    ...
                                    onConfirm: () {
                                      controller.delete(
                                        item.wholesaleCustomersId!.toString(),
                                      );
                                      Get.back();
                                    },
                                  );
