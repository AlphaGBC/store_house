import 'package:store_house/controller/supplier/add_controller.dart';
...
class SupplierAdd extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(SupplierAddController());
    final theme = Theme.of(context);

    return Scaffold(
      appBar: AppBar(title: Text("اضافة موردين"), centerTitle: true),
      body: Padding(
        padding: const EdgeInsets.all(14.0),
        child: GetBuilder<SupplierAddController>(
          builder:
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6),
                                      Text(
                                        "القائمة التالية تحوي اسماء الموردين",
